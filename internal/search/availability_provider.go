...
func NewAvailabilityProvider(db *sql.DB) SearchProvider {
	return &availabilityProvider{db: db}
}

func (p *availabilityProvider) GetEntityType() EntityType {
	return EntityAvailability
}

func (p *availabilityProvider) GetEntityLabel() string {
	return "Doctor Schedules"
}

func (p *availabilityProvider) Search(ctx context.Context, tenantID uuid.UUID, query string, limit int) ([]SearchResultItem, error) {
